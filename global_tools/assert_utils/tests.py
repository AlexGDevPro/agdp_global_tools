...
def test_check_assert_no_exception_succeed():
    return Assert.assert_no_exception(AGDPTest.func_for_test_return_true)


def test_check_assert_no_exception_fail():
    return not Assert.assert_no_exception(AGDPTest.func_for_test_with_exception)
...
def test_assert_exception_is_raised_succeed():
    return Assert.assert_exception_is_raised(AGDPTest.func_for_test_with_exception)


def test_assert_exception_is_raised_fail():
    return not Assert.assert_exception_is_raised(AGDPTest.func_for_test_return_true)
...
def test_assert_exception_is_raised_raise_error_with_wrong_exception_type_type():
    exception_type = 123
    try:
        Assert.assert_exception_is_raised(AGDPTest.func_for_test_return_true, exception_type)
    except TypeError:
        return True
    return False
...
def test_assert_exception_is_raised_succeed_with_none_as_exception_type():
    return Assert.assert_exception_is_raised(AGDPTest.func_for_test_with_exception, None)


def test_assert_exception_is_raised_succeed_with_exception_type():
    return Assert.assert_exception_is_raised(AGDPTest.func_for_test_with_exception, SyntaxError())


def test_assert_exception_is_raised_fail_with_exception_type():
    return not Assert.assert_exception_is_raised(AGDPTest.func_for_test_with_exception, TypeError())
...
def test_assert_is_true_succeed():
    return Assert.assert_is_true(AGDPTest.func_for_test_return_true)


def test_assert_is_true_fail():
    return not Assert.assert_is_true(AGDPTest.func_for_test_return_false)
...
def test_assert_is_true_raise_error_with_wrong_func_return_type():
    try:
        Assert.assert_is_true(AGDPTest.func_for_test_return_str)
    except TypeError:
        return True
    return False
...
def test_assert_is_false_succeed():
    return Assert.assert_is_false(AGDPTest.func_for_test_return_false)


def test_assert_is_false_fail():
    return not Assert.assert_is_false(AGDPTest.func_for_test_return_true)
...
def test_assert_is_false_raise_error_with_wrong_func_return_type():
    try:
        Assert.assert_is_false(AGDPTest.func_for_test_return_str)
    except TypeError:
        return True
    return False
